...
Dataset: 
We used several datasets in our analysis:
We get bachelor's majors in each state, age and sex category in 2019, U.S. population and median income in each state in 2019, and U.S. educational finances data from the US Census Bureau; For the salary data of each major and 
