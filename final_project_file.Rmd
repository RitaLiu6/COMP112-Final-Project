...
Bachelor_Degree_Majors %>%
  ...
  scale_fill_manual(
    name = NULL,
    values = c("dodgerblue", "tomato3", "goldenrod1", "darkorange1", "slateblue4")) +
  labs(title = "", 
       subtitle = "",
       fill = "") +
...
Bachelor_Degree_Majors %>%
  ...
  scale_fill_manual(
    name = NULL,
    values = c("tomato3", "dodgerblue", "goldenrod1", "darkorange1", "slateblue4")) +
  labs(title = "", 
       subtitle = "",
       fill = "") +
  theme(legend.position = "bottom",
...
#                     Advanced)) %>%
  ...
  scale_fill_manual(
    name = NULL,
    values = c("slateblue4", "dodgerblue", "lightgoldenrod", "goldenrod1", "darkorange1", "tomato3")) +
  theme(legend.position = "bottom")
```
